    ...
    :(
      ...
      {!isLoading && data && (
        ...
        >
          ...
          <div className="w-full h-full grid grid-cols-1 md:grid-cols-3 gap-7 px-[30px] ss:px-16 md:px-20 mb-[270px] relative">
            
            <div className="hidden ss:flex text-[#354dc2] font-Spartan font-bold absolute top-[132px]  left-[-132px] rotate-90 leading-[2.5em] tracking-[1.2em]">
              Please log in
            </div>
          </div>
          <Footer />
